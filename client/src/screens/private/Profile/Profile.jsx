...
import { useProfileDetailsQuery, useUpdateProfileMutation } from '../../../redux/services/profileService';
...
const Profile = () => {
   ...
   * form handle submit
   */
  const submitForm = ({ name, mobile, address }) => {
    const postBody = {
      name,
      mobile,
      address,
      image: userImgView.src,
    };

    updateProfile(postBody);
  };
                ...
                <Col sm={4}>
                  <Form.Group className="mb-3" controlId="image">
                    ...
                    <Controller
                      ...
                      name="image"
                      render={({ field }) => (
                        <Form.Control onChange={previewImage} ref={(input) => (userImgRef = input)} type="file" size="sm" />
                      )}
                    />
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, onBlur, value, ref } }) => (
                        <Form.Control
                          ...
                          placeholder={t('name of the profile')}
                          type="text"
                          size="sm"
                        />
                      )}
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, onBlur, value, ref } }) => (
                        <Form.Control
                          ...
                          placeholder={t('mobile of the profile')}
                          type="number"
                          size="sm"
                        />
                      )}
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, onBlur, value, ref } }) => (
                        <Form.Control
                          ...
                          placeholder={t('address of the profile')}
                          as="textarea"
                          size="sm"
                        />
                      )}
              ...
              <Row>
                <Col sm={4}>
                  <Button size="sm" className="mt-2" type="submit">
                    {isLoading ? <Spinner size="sm" color="light" /> : t('save change')}
                  </Button>
                </Col>
              </Row>
            </Form>
